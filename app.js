  ...
  categoryPills.forEach(pill => {
    pill.addEventListener('click', () => {
      categoryPills.forEach(p => {
        p.className = 'cat-pill px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-semibold bg-slate-900/90 text-slate-300 border border-slate-800 hover:border-slate-700 hover:bg-slate-800 hover:text-white transition-all shadow-sm tracking-wide';
      });
      pill.className = 'cat-pill active px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-bold bg-cyan-500 text-slate-950 shadow-glow-cyan transition-all border border-cyan-400 tracking-wide';
  ...
  if (resetFiltersBtn) {
    resetFiltersBtn.addEventListener('click', () => {
      ...
      categoryPills.forEach((p, idx) => {
        p.className = idx === 0 
          ? 'cat-pill active px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-bold bg-cyan-500 text-slate-950 shadow-glow-cyan transition-all border border-cyan-400 tracking-wide'
          : 'cat-pill px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-semibold bg-slate-900/90 text-slate-300 border border-slate-800 hover:border-slate-700 hover:bg-slate-800 hover:text-white transition-all shadow-sm tracking-wide';
      });
